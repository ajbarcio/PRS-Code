...
Ics = np.array([0.004, 0.000025, 0.002])

curvedSpring = Spring(radii=np.array([R0,R1,R2,R3]),betaAngles=np.array([0,betaB,betaC,beta0]),IcPts=Ics,IcArcLens=np.array([0.75]))
